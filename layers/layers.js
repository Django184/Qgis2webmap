...
//ol.proj.get("EPSG:2056").setExtent([2566476.630587, 1062703.021040, 2724036.005587, 1155333.646040]);
var wms_layers = [];
...
var format_Links_12 = new ol.format.GeoJSON();
var features_Links_12 = format_Links_12.readFeatures(json_Links_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2056'});
var jsonSource_Links_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Links_12.addFeatures(features_Links_12);
var lyr_Links_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Links_12, 
                style: style_Links_12,
                popuplayertitle: 'Links',
                interactive: false,
                title: '<img src="styles/legend/Links_12.png" /> Links'
            });
...
var group_Projects = new ol.layer.Group({
                                layers: [lyr_Links_12,lyr_Lots_13,],
                                fold: 'close',
                                title: 'Projects'});
...
lyr_Links_12.set('fieldAliases', {'id': 'id', });
...
lyr_Links_12.set('fieldImages', {'id': '', });
...
lyr_Links_12.set('fieldLabels', {'id': 'no label', });
